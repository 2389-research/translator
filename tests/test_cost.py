...
def test_estimate_cost_with_editing():
    ...
    cost_without_edit, _ = CostEstimator.estimate_cost(token_count, model, with_edit=False)
...
def test_estimate_cost_with_critique():
    ...
    cost_with_critique, _ = CostEstimator.estimate_cost(token_count, model, with_critique=True)
    cost_without_critique, _ = CostEstimator.estimate_cost(token_count, model, with_critique=False)
...
def test_estimate_cost_with_multiple_critique_loops():
    ...
    cost_1_loop, _ = CostEstimator.estimate_cost(token_count, model, with_critique=True, critique_loops=1)
    cost_2_loops, _ = CostEstimator.estimate_cost(token_count, model, with_critique=True, critique_loops=2)
    cost_3_loops, _ = CostEstimator.estimate_cost(token_count, model, with_critique=True, critique_loops=3)
...
def test_estimate_cost_zero_loops():
    ...
    cost_with_zero_loops, _ = CostEstimator.estimate_cost(token_count, model, with_critique=True, critique_loops=0)
    cost_without_critique, _ = CostEstimator.estimate_cost(token_count, model, with_critique=False)
...
def test_estimate_cost_with_mock_costs():
    ...
    with patch.object(ModelConfig, 'get_input_cost', return_value=0.01):
        with patch.object(ModelConfig, 'get_output_cost', return_value=0.02):
            ...
            cost, _ = CostEstimator.estimate_cost(token_count, model, with_edit=False, with_critique=False)
