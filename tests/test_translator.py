...
def test_translate_text(translator_instance):
    ...
    translated_text, usage = translator_instance.translate_text(text, target_language, model)
...
def test_translate_text_error(translator_instance):
    ...
    translator_instance.client.chat.completions.create.side_effect = Exception("API Error")
...
def test_translate_frontmatter_no_fields(translator_instance):
    ...
    frontmatter_data = {"title": "Original Title", "description": "Original Description"}
    fields = []
